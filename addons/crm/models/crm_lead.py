...
class Lead(models.Model):
    ...
    partner_id = fields.Many2one('res.partner', string='Customer', track_visibility='onchange', index=True, ondelete='restrict',
        help="Linked partner (optional). Usually created when converting the lead.")
    compagne_id = fields.Many2one('compagne.compagne', 'Campagne', ondelete='restrict')
